...
public class MyCustomerHotOffer extends BaseAdapter implements ListAdapter {
    ...
    public MyCustomerHotOffer(ArrayList<String> list,ArrayList<String> list1,ArrayList<String> list2, Context context) {
        this.list = list;
        this.list1=list1;
        this.list2=list2;
    ...
    public MyCustomerHotOffer(ArrayList<String> list,ArrayList<String> list2, Context context) {
        this.list = list;
        ...
        read.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
               ...
               // intent.putExtra("agent_name", list2.get(position));
                intent.putExtra("news_pic", list2.get(position));
